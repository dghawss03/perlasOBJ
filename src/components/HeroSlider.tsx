...
const slides = [
  { kicker:'Perlas Objektbetreuung', title:'Objekte in besten Händen.', text:'Seit über 25 Jahren betreuen wir Immobilien mit einem klaren Anspruch: mitdenken, Verantwortung übernehmen und langfristig erreichbar bleiben.', cta:'Perlas kennenlernen', href:'/ueber-uns', image:'/images/50288a60-5bad-4087-9483-565d96e36730.png', alt:'Mitarbeiter von Perlas mit Tablet vor einer modernen Gewerbeimmobilie' },
